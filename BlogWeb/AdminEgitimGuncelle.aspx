    ...
    <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <div>
                ...
                <asp:TextBox ID="txtEgitimId" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            ...
            <asp:Button ID="btnEgitimGuncelle" runat="server" CssClass="btn btn-info" Text="Güncelle" OnClick="btnEgitimGuncelle_Click"    />

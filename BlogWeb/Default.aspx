...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="Dosyalar/blogTema/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
    <!-- Custom fonts for this template -->
    <link href="https://fonts.googleapis.com/css?family=Saira+Extra+Condensed:500,700" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Muli:400,400i,800,800i" rel="stylesheet">
    <link href="Dosyalar/blogTema/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="Dosyalar/blogTema/css/resume.min.css" rel="stylesheet">
</head>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            <span class="d-block d-lg-none">Emir Tanta</span>
            <span class="d-none d-lg-block">
                <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="Dosyalar/blogTema/img/profile.jpg" alt="">
            </span>
        </a>
            ...
            <div class="my-auto">
                ...
                <asp:Repeater ID="Repeater4" runat="server">
                    ...
                    <li>
                        ...
                        <asp:Label ID="Label21" runat="server" Text='<%#Eval("YETENEK") %>'></asp:Label>
                    ...
                    <ItemTemplate>
                        <ul class="fa-ul mb-0">
                            <li>
                                ...
                                <asp:Label ID="Label17" runat="server" Text='<%#Eval("KURUM") %>'></asp:Label> <asp:Label ID="Label18" runat="server" Text='<%#Eval("AD") %>'></asp:Label> <asp:Label ID="Label19" runat="server" Text='<%#Eval("TARIH") %>'></asp:Label> <asp:Label ID="Label20" runat="server" Text='<%#Eval("ACIKLAMA") %>'></asp:Label>
    ...
    <script src="Dosyalar/blogTema/vendor/jquery/jquery.min.js"></script>
    <script src="Dosyalar/blogTema/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Plugin JavaScript -->
    <script src="Dosyalar/blogTema/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for this template -->
    <script src="Dosyalar/blogTema/js/resume.min.js"></script>

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <div>
                <asp:Label ID="lblId" runat="server" Text="Sertifika Id"></asp:Label>
                <asp:TextBox ID="txtSertifikaId" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            ...
            <asp:Button ID="btnSertifikaGuncelle" runat="server" CssClass="btn btn-info" Text="Güncelle" OnClick="btnSertifikaGuncelle_Click"  />
